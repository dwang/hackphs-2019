...
def on_new_sample(sink, appsrc, overlay, screen_size, appsink_size, user_function):
...
def run_pipeline(
    ...
    if use_appsrc:
        ...
        appsrc_pipeline = APPSRC_PIPELINE.format(
            leaky_q=LEAKY_Q, appsrc_caps=appsrc_caps, videoflip=videoflip
        )
